...
namespace MusicShopApplication.Controllers
{
    ...
    {
        private readonly MusicShopApplicationContext _context;

        public MusicsController(MusicShopApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MusicShopApplicationContext.Music'  is null.");
            }
            var music = await _context.Music.FindAsync(id);
            if (music != null)
            {
